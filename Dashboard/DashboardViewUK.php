...
<body>
    <nav class="navbar">
        <div class="logo_item">
            ...
            <img src="../Login/UMPLogo.png" alt="">LETSPARK@FK
            <h1>Welcome, <?php echo htmlspecialchars($_SESSION['SESS_NAME']); ?>!</h1>
        </div>

        <div>
            <ul class="nav__wrapper">
                <li class="nav__item"><a href="../Dashboard/DashboardViewUK.php">Home</a></li>
                <li class="nav__item"><a href="#">About</a></li>
                <li class="nav__item"><a href="../Dashboard/StudentChart.php">Dashboard</a></li>
    ...
    <nav class="sidebar">
        <div class="menu_content">
            <ul class="menu_items">
                <li class="item">
                    <a class="nav_link submenu_item" href="../DisplayUser/UKEditProfile.php">
